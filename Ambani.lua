...
if not isfolder("ambani") then makefolder("ambani") end

function library:createConfig()
    local name = library.flags["config_name"]
    if contains(library.options["selected_config"].values, name) then return library:notify(name .. " already exists!") end
